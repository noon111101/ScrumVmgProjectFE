...
<template>
  <div class="sidebar" :style="{ width: sidebarWidth}" >
    <h1>
      ...
      <img src="https://vmgmedia.vn/Content/images/logo/01.png" style="width:100px" v-else>
    </h1>
  <div>
          ...
          <router-link  v-if="showAdminBoard" to="/admin" class="nav-link">Admin Board</router-link>
           ...
           <router-link v-if="showAdminBoard" to="/timesheet" class="nav-link">Time Sheet</router-link>
