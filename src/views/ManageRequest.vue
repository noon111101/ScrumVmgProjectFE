<template>
  <el-tabs v-model="activeName" @tab-click="handleClick">
    ...
    <el-tab-pane label="Chờ phê duyệt" name="third">Role</el-tab-pane>
    <el-tab-pane label="Đã phê duyệt" name="fourth">Task</el-tab-pane>
    <el-tab-pane label="Đã từ chối" name="five">Task</el-tab-pane>
  </el-tabs>
</template>
<script>
export default {
