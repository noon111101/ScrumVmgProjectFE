        ...
        <div class="col-lg-4">
          <div class="card mb-4">
            <div class="card-body text-center">
              <img src="https://image.thanhnien.vn/460x258/Uploaded/2022/oqivotiw/2022_06_19/cristiano-ronaldo-8084.jpeg" alt="avatar"
                   class="rounded-circle img-fluid" style="width: 150px;">
              <h5 class="my-3">{{ currentUser.username }}</h5>
              <p class="text-muted mb-1">Dev</p>
              <p class="text-muted mb-4">Sao Hỏa</p>
